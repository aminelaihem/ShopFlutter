...
void main() {
  ...
  group('Tests de compatibilité', () {
    testWidgets('Test de compatibilité - Thème sombre', (WidgetTester tester) async {
    ...
    testWidgets('Test de compatibilité - Thème clair', (WidgetTester tester) async {
    ...
    testWidgets('Test de compatibilité - Tailles d\'écran', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Test de compatibilité - Orientation', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Test de compatibilité - Densité de pixels', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Test de compatibilité - Accessibilité', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
