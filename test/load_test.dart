...
void main() {
  ...
  group('Tests de charge', () {
    testWidgets('Test de charge - Chargement initial', (WidgetTester tester) async {
    ...
    testWidgets('Test de charge - Navigation répétée', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Test de charge - Rendu de widgets', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Test de charge - Gestion des événements', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
