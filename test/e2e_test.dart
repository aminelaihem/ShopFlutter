...
void main() {
  ...
  group('Tests End-to-End', () {
    testWidgets('E2E - Parcours utilisateur complet', (WidgetTester tester) async {
    ...
    testWidgets('E2E - Test de navigation complète', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
      ...
      for (int i = 0; i < buttonCount && i < 10; i++) {
        ...
        try {
          ...
          final backButtons = find.byIcon(Icons.arrow_back).or(find.text('Retour'));
    ...
    testWidgets('E2E - Test de persistance des données', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('E2E - Test de performance utilisateur', (WidgetTester tester) async {
      ...
      if (buttons.evaluate().isNotEmpty) {
        ...
        for (int i = 0; i < buttons.evaluate().length && i < 3; i++) {
          ...
          print('Temps de réponse bouton $i: ${stopwatch.elapsedMilliseconds}ms');
        }
      }
    });

    testWidgets('E2E - Test de récupération d\'erreurs', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
