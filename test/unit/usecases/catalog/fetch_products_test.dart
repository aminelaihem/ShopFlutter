...
void main() {
  group('FetchProducts Use Case', () {
    ...
    test(
      'devrait retourner une liste de produits quand la récupération réussit',
      () async {
        // Arrange
    ...
    test(
      'devrait retourner une liste vide quand aucun produit n\'est trouvé',
      () async {
        // Arrange
        when(
          mockRepository.fetchProducts(),
    ...
    test('devrait propager l\'exception du repository', () async {
      ...
      // Act & Assert
      expect(() => fetchProductsUseCase(), throwsA(isA<Exception>()));
    });
