...
final signInUsecaseProvider = Provider<uc.SignIn>(
  (ref) => uc.SignIn(ref.watch(authRepositoryProvider)),
);
final registerUsecaseProvider = Provider<uc.Register>(
  (ref) => uc.Register(ref.watch(authRepositoryProvider)),
);
final signInWithGoogleUsecaseProvider = Provider<uc.SignInWithGoogle>(
  (ref) => uc.SignInWithGoogle(ref.watch(authRepositoryProvider)),
);
final registerWithGoogleUsecaseProvider = Provider<uc.RegisterWithGoogle>(
  (ref) => uc.RegisterWithGoogle(ref.watch(authRepositoryProvider)),
);
final signOutUsecaseProvider = Provider<uc.SignOut>(
  (ref) => uc.SignOut(ref.watch(authRepositoryProvider)),
);
final watchAuthStateUsecaseProvider = Provider<uc.WatchAuthState>(
  (ref) => uc.WatchAuthState(ref.watch(authRepositoryProvider)),
);
