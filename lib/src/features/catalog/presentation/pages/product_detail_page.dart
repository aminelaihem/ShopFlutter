                                ...
                                child: Row(
                                  children: [
                                    IconButton(
                                      ...
                                      icon: const Icon(Icons.remove_rounded, color: Color(0xFF6366F1)),
                                    ),
                                    Container(
                ...
                onPressed: () async {
                  try {
                    for (int i = 0; i < _quantity; i++) {
                      await ref.read(cartVmProvider.notifier).addFromProductId(widget.id);
                    }
                    if (mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text('$_quantity produit(s) ajouté(s) au panier'),
